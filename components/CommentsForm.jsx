    ...
    <div className="bg-gradient-to-r from-red-500 to-yellow-500 p-1 mb-8 shadow-lg rounded-md lg:rounded-lg">
      <div className="bg-gray-700 shadow-lg rounded-md lg:rounded-lg p-3 sm:p-6 lg:p-8">
        ...
        <div className="grid grid-cols-1 gap-4 mb-4">
          <textarea ref={commentEl} className="p-4 outline-none w-full rounded-md lg:rounded-lg h-40 focus:ring-2 focus:ring-gray-200 bg-gray-100 text-gray-900" placeholder="Comment" name="comment" />
        </div>
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 mb-4">
          <input type="text" ref={nameEl} className="py-2 px-4 outline-none w-full rounded-md lg:rounded-lg focus:ring-2 focus:ring-gray-200 bg-gray-100 text-gray-900" placeholder="Name" name="name" />
          <input type="text" ref={emailEl} className="py-2 px-4 outline-none w-full rounded-md lg:rounded-lg focus:ring-2 focus:ring-gray-200 bg-gray-100 text-gray-900" placeholder="Email" name="email" />
        </div>
        <div className="grid grid-cols-1 gap-4 mb-4">
          <div>
