    ...
    switch (type) {
      ...
      case "code-block":
        ...
        return (
          <div
            key={index}
            className="bg-gray-900 px-2 py-1 mb-6 rounded-md lg:rounded-lg font-mono"
          >
            <div
              className="overflow-x-auto scrollbarStyle pt-2 pb-3"
      ...
      case "bulleted-list":
        ...
        return (
          <ul key={index} className="mb-6 list-disk">
            {data1}
          </ul>
        );
      ...
      case "numbered-list":
        ...
        return (
          <ol key={index} className="list-decimal mb-6">
            {data2}
          </ol>
        );
      ...
      <div className="bg-gray-700 shadow-lg rounded-md lg:rounded-lg  pb-2 mb-8">
        <div className="relative overflow-hidden shadow-md mb-6">
          <img
            ...
            alt={post.title}
            className="object-top h-full w-full object-cover  shadow-lg rounded-t-lg lg:rounded-md lg:rounded-lg"
          />
        </div>
